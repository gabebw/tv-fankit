...
function fk_episode_notices(){
	...
	$txt = $new_ep_txt . __("The page title is the episode title, and the page content is the episode description. To add more information, including a transcript, use the boxes below the writing area. To add an autogenerated quote page, do BLAHHH"); // FIXME
