<?php
// Setup tables for vmars

require_once('db_setup.php');
// TODO: check if tables exist first
// maybe have an fk_dbinfo table?
// with version
...
foreach($tables as $t){
    ...
    /*
    rescue Mysql::Error => boom
	puts "Error occurred: #{boom}; table probably didn't exist."
	end
     */
}

# Create tables if they don't exist.
$create_strings = array($appearance_create, $cast_create, $episode_create,
			$ref_create, $transcript_create, $website_create);

foreach($create_strings as $cs){
    mysql_query($cs);
    //puts "An error occurred: #{boom}"
}
