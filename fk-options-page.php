...
printf('<input type="checkbox" id="cu-id" name="fk_completely_uninstall"%s /> ',
	$cu_checked);
_e('Check this box to remove all TV Fan Kit information when TV Fan Kit is deactivated. This <em>will not</em> delete your posts; they will just not have the extra Fan Kit data (characters, seasons, etc.) anymore. If you leave it unchecked (recommended), then TV Fan Kit will keep the information.');
?>
</label>
</td>
</tr>
...
printf('<input type="checkbox" id="sn-id" name="fk_show_notices"%s /> ',
	$sn_checked);
_e('Enable helpful getting-started notices when editing posts.');
?>
</label>
</td>
</tr>
...
_e('Check this to delete characters when the actor/actress who plays them is deleted. This <em>will not</em> delete the actual Wordpress posts. It will simply remove the TV Fan Kit data for the characters.');
?>
</label>
</td>
</tr>
